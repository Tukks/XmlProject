    ...
    public String chartFOP() throws IOException {
        ...
        try {
            ...
            String input = "declare namespace e = \"http://ref.otcnice.com/webservice/\";\n"
                    ...
                    + "let $prixUneEtoile :=  avg($UneEtoile/e:tariffs/e:tariff/e:min)               let $DeuxEtoile := $doc/e:entries/e:entry[e:standings_levels/e:standings_level = '2 étoiles']\n"
    ...
    public String stats() throws IOException {
        ...
        try {
            ...
            String input = "declare namespace e = \"http://ref.otcnice.com/webservice/\";\n"
                    ...
                    + "\n"
                    + "let $QuattreEtoile := $entries[e:standings_levels/e:standings_level = '4 étoiles']\n"
                    + "let $nombreHotel4 := count($QuattreEtoile)\n"
                    + "let $totalLangueParlee4 := count(distinct-values($QuattreEtoile/e:languages/e:language))\n"
                    + "let $totalNombrePaiment4 := count(distinct-values($QuattreEtoile/e:payments/e:payment))\n"
                    + "let $totalChambreHotel4 := sum($QuattreEtoile/e:living/e:room_count)\n"
                    + "let $prixMoyenChambre4 := avg($QuattreEtoile/e:tariffs/e:tariff/e:min)\n"
                    + "\n"
